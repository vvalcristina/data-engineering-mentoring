...
Capybara.register_driver :zalenium do |app|
  options = [
    '--start-maximized',
    '--disable-infobars',
    '--incognito',
  ...
  caps = Selenium::WebDriver::Remote::Capabilities.chrome(
    ...
    'zal:name': ENV['EXEC_ID']
  )
  Capybara::Selenium::Driver.new(app, browser: :remote, desired_capabilities: caps, url: ENV['ZALENIUM_URL'])
end
